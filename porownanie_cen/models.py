...
class Produkt(models.Model):
    ...
    cenakatalogowa = models.DecimalField(db_column='cenaKatalogowa', max_digits=12, decimal_places=4, blank=True, null=True)
    ...
    cenakatalogowa_eur = models.DecimalField(db_column='cenaKatalogowa_EUR', max_digits=12, decimal_places=4, blank=True, null=True)
    cenakoncowa_eur = models.DecimalField(db_column='cenaKoncowa_EUR', max_digits=12, decimal_places=4, blank=True, null=True)
